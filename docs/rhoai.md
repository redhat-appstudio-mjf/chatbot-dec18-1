...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot-dec18-1`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot-dec18-1-notebook`.
...
5) In the terminal, run `cd chatbot-dec18-1` to navigate to your sample app's directory.
